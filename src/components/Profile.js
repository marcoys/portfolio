    ...
    <div className={'profile start ' + fade}  style={{ marginLeft: (leftWidth) + (naviWidth)}}>
      ...
      <div className='container'>
        <section>
          ...
          <p>
            대학교 졸업 무렵, 주변 개발자 친구들을 통해 웹 퍼블리셔라는 직군을 알게되었고, 국비지원 프로그램을 신청하여 IT의 길로 입문하게 되었습니다.<br />이 후, 웹 에이전시 회사에 취업하여 2년 반 동안 웹 퍼블리셔로 근무하며 커리어를 시작하게 되었습니다.<br />
            <br />
            다른 웹 개발자님들과 여러 프로젝트를 진행하고 기능 오류를 수정/분석하는 유지보수 작업을 하다 자연스레 웹 개발에 관심이 생겼고, 프론트엔드 개발자로 발돋움하기 위해 공부를 시작하게 되었습니다. 
          </p>
        </section> 
        <section>
          <h1>CAREER</h1>
