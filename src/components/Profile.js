    ...
    <div className={'profile start ' + fade}  style={{ marginLeft: (leftWidth) + (naviWidth)}}>
      ...
      <div className='container'>
        <section>
          ...
          <p>
            대학교 졸업 무렵, 웹 퍼블리셔라는 직군을 알게되어 국비지원 프로그램을 다니며 IT에 입문하게 되었고, 이 후 2년 반 동안 웹 퍼블리셔로 근무하며 커리어를 시작하게 되었습니다. <br />이 후 단순 홈페이지 제작을 하는 웹 퍼블리셔를 넘어 프론트엔드 개발을 하고싶다는 욕심이 생겨 개발 공부를 시작하게 되었습니다. 
          </p>
        </section> 
        <section>
          <h1>CAREER</h1>
